...
Coeff_file = f'data/European_region_sample_CERRA_Chebyshev_coefficients.nc'
target_variables = [0,1,2,3,4]

test_station_ids = ('P41', 'P42', 'P43', 'P44', 'P45', 'P46', 'P47', 'P48', 'P49', 'P50')
test_dates_range = ('2020-01-01T00:00:00', '2020-12-31T23:00:00')

experiment = f'ERA5_to_CERRA'
...
if len(station_ids) == 1:
    ...
    model_output_dir = f'trained_models/{experiment}/{station_id}/{years_experiment}/{transformed}/{loss_function}/Ens{Ens}'
else:
    model_output_dir = f'trained_models/{experiment}/{len(station_ids)}_stations/{years_experiment}/{transformed}/{loss_function}/Ens{Ens}'
...
for station_id in station_ids:
    X_train, Y_train, X_valid, Y_valid,_,_ = data_processing(input_file,Coeff_file,
                                                        input_times_freq,input_variables,target_variables,train_dates_range,station_id,val_arg=True,rng_data=rng_data)
...
for station_id in test_station_ids:
    X_test, Y_test, _ = data_processing(input_file,Coeff_file,
                                    input_times_freq,input_variables,target_variables,test_dates_range,station_id,val_arg=None)
